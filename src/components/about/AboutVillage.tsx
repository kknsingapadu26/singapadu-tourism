    ...
    <div className="pt-32 pb-24 max-w-[1200px] mx-auto px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex flex-col gap-4 bg-[var(--surface-card)] border border-[var(--border)] rounded-sm shadow-[var(--shadow-card)] p-6">
          ...
          <h3 className="text-2xl font-extrabold text-[var(--text-primary)] m-0">
          ...
          <div className="flex items-center gap-7 pt-2 flex-wrap">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-sm bg-emerald-900/60 border border-emerald-700/40 text-emerald-300 flex items-center justify-center font-black text-xs shadow-xs">
                DESA
              </div>
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-sm bg-sky-900/60 border border-sky-700/40 text-sky-300 flex items-center justify-center font-black text-xs shadow-xs">
                PNB
              </div>
              <span className="text-xs font-semibold text-[var(--text-secondary)] leading-snug">
