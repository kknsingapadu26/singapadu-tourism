...
export const Button: React.FC<ButtonProps> = ({
  ...
  let baseStyles = 'inline-flex items-center justify-center font-semibold transition-all duration-200 cursor-pointer rounded-md border text-center focus:outline-none focus:ring-2 focus:ring-[var(--focus-ring)] focus:ring-offset-1';
  ...
  switch (variant) {
    case 'primary':
      ...
      break;
    case 'secondary':
      variantStyles = 'bg-[var(--brand-secondary)] hover:bg-[var(--brand-secondary-hover)] text-white border-transparent shadow-sm';
      break;
    case 'accent':
      variantStyles = 'bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-neutral-900 border-transparent shadow-sm font-bold';
      break;
    case 'outline':
